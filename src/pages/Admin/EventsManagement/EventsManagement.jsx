...
import { getEvents, addEvent, updateEvent, deleteEvent } from '../../../utils/dataService';
...
const EventsManagement = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingEvent) {
      updateEvent(editingEvent.id, eventItem);
    } else {
      addEvent(eventItem);
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-[700] text-gray-900">Events Management</h2>
        <button
