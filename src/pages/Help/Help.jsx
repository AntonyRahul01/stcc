  ...
  const fetchNewsAndEvents = async (page = 1, limit = 18) => {
    try {
      ...
      if (response.success && response.data) {
        ...
        // Filter only community-fund items
        const communityFundItems = allItems.filter(
          (item) => item.category_slug === "community-fund"
        );
        const mappedData = mapApiDataToComponent(communityFundItems);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 py-3 mb-6">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#FF0000] font-[400]">
        ...
        {/* Page Title */}
        <h1 className="text-[30px] font-[700] text-black mb-8">
          உறவுக்கு கைகொடுப்போம்
        </h1>
